...
public class ScheduleServiceImpl implements ScheduleService {
	...
	public void getSchedule() {
	  ...
	  String ym = "";
	  int intMM = mm + 1; // 월은 0부터 시작이기때문에 1을 더해야함
	...
	public List<ScheduleVO> getScheduleMenu(String mid, String ymd) {
		...
		// 2023-1-5 / 2023-1-15 / 2023-10-5 ==> 2023-00-00
		if(ymd.length() != 10) {
	...
	public void scheduleInputOkPost(ScheduleVO vo) {
		...
		System.out.println("편집한 ydm : " + ymd );
		scheduleDAO.scheduleInputOkPost(vo);
	}

	@Override
	public int scheduleDeleteOk(int idx) {
		return scheduleDAO.scheduleDeleteOk(idx);
	}

	@Override
	public int scheduleUpdateOk(ScheduleVO vo) {
		return scheduleDAO.scheduleUpdateOk(vo);
	}
}
