...
public class MemberController {
	...
	public String memberKakaoLoginGet(HttpSession session, HttpServletRequest request, HttpServletResponse response,
		...
		if(vo==null) {
			...
			//임시 비밀번호 발급하기(여기서는 '0000'으로 발급하기로 한다.);
		  String pwd = "0000";
		...
		session.setAttribute("KakaoLevel", strLevel);
	...
	// 로그아웃
	@RequestMapping(value = "/memberKakaoLogout", method = RequestMethod.GET)
	public String memberKakaoLogoutGet(HttpSession session) {
