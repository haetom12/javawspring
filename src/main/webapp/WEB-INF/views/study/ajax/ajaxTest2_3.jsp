  		...
  		$("#dodo").change(function(){
  			...
  			$.ajax({
  				...
  				success:function(res) {
  					...
  					for(let i=0; i<res.city.length; i++){  //key의 이름으로 찾아야함 / res안의 city의 길이
  						//if(res.city[i]==null) break; 값이 city 하나라서 필요없음
...
<p><br/></p>
<div class="container">
	<h2>AJax를 활용한 값의 전달3(Map(HashMap<k,v>)처리)</h2>
	<hr />
	<form name="myform">
		<h3>도시를 선택하세요</h3>
