  ...
  <jsp:include page="/WEB-INF/views/include/bs4.jsp"></jsp:include>
    ...
    function jusorokView() {
    	$("#myModal").on("show.bs.modal", function(e){
    		...
    		jusorok += '<tr onclick"location.href=\'${ctp}/study/mail/mailForm?emailS=${vo.email}\';" class="text-center">';
  ...
  <form name="myform" method="post">
  	<table class="table table-bordered">
  		<tr>
		    <th>주 소 록</th>
		    <td>
	        <select name="email" id="email" onchange="mailSelect()" class="form-control">
  		...
  		<tr>
  			...
  			<td>
          <div class="row">
	          <div class="col-10"><input type="text" name="toMail" placeholder="받는사람 메일주소를 입력하세요." value="${email}" class="form-control" required /></div>
