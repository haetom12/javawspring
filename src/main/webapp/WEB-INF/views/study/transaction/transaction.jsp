...
<div class="container">
	<form name="myform" method="post" >
	  ...
	  <pre>
	  	...
	  	두개이상의 작업중 하나라도 처리가 미결된다면 모든 작업은 동시에 초기화 되어야 한다.(원자성) - Roll back
	  </pre>
	  <hr />
	  <h2>User 등록폼</h2>
	  <table>
	  	...
	  	<tr>
	  		<td colspan="2" class="text-center">
	  			<div class="row">
		  			...
		  			<div class="col"><input type="button" value="리스트로가기" onclick="location.href='transactionList';" class="btn btn-info form-control" /></div>
	  			</div>
	  		</td>
	  	</tr>
	  </table>
