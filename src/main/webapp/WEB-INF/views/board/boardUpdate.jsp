...
<div class="container">
  <form name="myform" method="post">
    ...
    <table class="table">
      ...
      <tr>
        <th>글내용</th>
        <td><textarea rows="6" id="CKEDITOR" name="content" class="form-control" required>${vo.content}</textarea></td>
        <script>
        	CKEDITOR.replace("content",{
        		height:500,
        		filebrowserUploadUrl:"${ctp}/imageUpload",
        		uploadUrl : "${ctp}/imageUpload" // 드래그해서 그림파일을 올리는것
        	});
        </script>
      </tr>
      <tr>
        <td colspan="2" class="text-center">
          ...
          <input type="button" value="돌아가기" onclick="location.href='${ctp}/board/boardContent?pag=${pag}&pageSize=${pageSize}?idx=${vo.idx}';" class="btn btn-secondary"/>
        </td>
      </tr>
    </table>
